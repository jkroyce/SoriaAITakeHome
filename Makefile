...
.PHONY: setup fetch test contract demo trial live tick ui chat sessions cost golden diagnose
setup fetch test contract demo trial live tick ui chat sessions cost golden diagnose:
	@$(PY) run.py $@
